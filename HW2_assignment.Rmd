---
title: "HW 3: From correlation to linear mixed-effect models. Assignment sheet"
knit: (function(inputFile, encoding) { 
      out_dir <- './../docs';
      rmarkdown::render(inputFile,
                        encoding=encoding, 
                        output_file=file.path(dirname(inputFile), out_dir, 'HW3.html')) })
editor_options: 
